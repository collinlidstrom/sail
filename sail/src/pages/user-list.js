    ...
    <section className="py-5">
      <Container>
        ...
        <div className="d-flex justify-content-between align-items-end mb-5">
          ...
          <Button href={data.button.link} color="link" className="text-muted">
            {data.button.title}
          </Button>
        </div>
        <div className="d-flex justify-content-between align-items-center flex-column flex-lg-row mb-5">
          ...
          <div className="text-center">
            ...
            />
            <Button href={data.download.link} color="outline-secondary">
                ...
                <Row>
                  <Col lg="4" className="align-self-center mb-4 mb-lg-0">
                    <div className="d-flex align-items-center mb-3">
                      ...
                      <div className="avatar avatar-sm avatar-border-white ml-3 overflow-hidden">
                        <Image
                    ...
                    <Row>
                      ...
                      <Col xs="12" lg="3" className="align-self-center">
                        ...
                        >
                          <i
                            className={`fa ${
                              booking.paid ? "fa-check" : "fa-times"
                            } fa-fw mr-2`}
                          />
                          Booking paid
                        </span>
                        ...
                        >
                          <i
                            className={`fa ${
                              booking.confirmed ? "fa-check" : "fa-times"
                            } fa-fw mr-2`}
                          />
                          Confirmed
                        </span>
