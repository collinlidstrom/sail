          ...
          <div>
            <Link passHref href="/user-messages">
              <Button color="link" className="pl-0">
                <i className="fa fa-arrow-left mr-2" /> Back to all messages
              </Button>
            </Link>
          </div>
        </div>
          ...
          <CardBody className="p-4">
            ...
            <div className="text-block pt-3 pb-0">
              <ul className="list-unstyled text-sm mb-0">
                <li className="mb-3">
                  <i className="fas fa-users fa-fw text-muted mr-2" />3 guests
                </li>
                <li className="mb-0">
        ...
        <div className="px-4 py-5">
          <Row>
            {data.map((message, index) => (
              ...
              >
                {!message.me && (
                  <div className="avatar avatar-border-white overflow-hidden">
                    <Image
                      src={message.image}
                      alt="user"
                      width={44}
        ...
        <Form className="bg-light rounded shadow-sm" action="#">
          <InputGroup>
            ...
            <InputGroupAddon addonType="append">
              <Button color="link" id="button-sendMessage" type="submit">
