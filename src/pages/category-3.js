        ...
        <Row>
          <Col lg="3" className="pt-3">
            <Form className="pr-xl-3">
              ...
              <div className="mb-4">
                <Label for="form_neighbourhood" className="form-label">
                  Neighbourhood
                </Label>
                <Select
                  name="neighbourhood"
              ...
              <div className="mb-4">
                <Label for="form_category" className="form-label">
                  Category
                </Label>
                <Select
                  name="category"
              ...
              {data.tags && (
                <div className="mb-4">
                  <Label className="form-label">{data.tags.title}</Label>
              ...
              <div className="pb-4">
                <Collapse isOpen={filterCollapse}>
                  {data.cuisine && (
                    <div className="mb-4">
                      <Label className="form-label">{data.cuisine.title}</Label>
                      <ul className="list-unstyled mb-0">
