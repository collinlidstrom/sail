...
const UserBookingDetail = () => {
  ...
  return (
    <Container fluid>
      <Row>
        <Col lg="7" xl="5" className="px-4 pb-4 pl-xl-5 pr-xl-5">
          ...
          <Breadcrumb listClassName="pl-0  justify-content-start">
            ...
            <BreadcrumbItem active>Trip to London</BreadcrumbItem>
          </Breadcrumb>
          ...
          <div className="text-block">
            <Media className="align-items-center mb-3">
              ...
              <Link href="/user-profile">
                <a>
                  <div className="avatar avatar-lg avatar-border-white ml-4 overflow-hidden">
                    <Image
            ...
            <Row className="mb-3">
              {data.members.map((member, index) => (
                <Col key={index} xs="auto" className="text-center text-sm">
                  <div className="avatar avatar-border-white mb-1 overflow-hidden">
                    <Image
            ...
            <Row>
              ...
              <Col className="col align-self-center">
                <p className="text-right d-print-none">
                  <Button color="link" href="#" className="text-muted">
